...
from .models import SCHEDULE_STATUS_DISABLED, SCHEDULE_STATUS_MISSED, SCHEDULE_STATUS_PENDING, ScheduleEntry
...
def sort_schedule_entries(entries: list[ScheduleEntry], reference_time: datetime | None = None) -> list[ScheduleEntry]:
    return sorted(
        entries,
